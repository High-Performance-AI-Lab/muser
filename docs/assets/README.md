...
`muser-onboarding-and-remote-prefill.mp4` is the real 1600×900 H.264 console
capture linked from the root README. Its SHA-256 is
...
frame from that capture and serves as the README poster.
